...
class Template
{
	...
	function __construct($config = array())
	{
		...
		$templateConfig = $this->_ci->config->item('template');
		if (isset($templateConfig) && !empty($templateConfig))
		{
			$this->initialize($templateConfig);
		}
	...
	private function _find_view_folder()
	{
		...
		{
			if(is_dir($this->_theme_path.'views/'))
