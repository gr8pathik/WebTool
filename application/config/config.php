...
|
*/
$config['encryption_key'] = '#$%WebTool@#$%PG#$@^%';
...
|
*/
$config['sess_cookie_name']		= 'webtool_session';
...
$config['template']['parser_enabled'] = FALSE;
...
$config['template']['parser_body_enabled'] = FALSE;
...
$config['template']['theme_locations'] = array(
	APPPATH.'../themes/admin/'
);
